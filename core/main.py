...
class Initialize(QtGui.QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        # set window title
        self.setWindowTitle(u'远禾科技 v' + version)
...
class WifiPumpkin(QtGui.QWidget):
    ...
    def __init__(self, mainWindow):
        ...
        self.item_settings.setText(u'设置')
        ...
        self.item_plugins.setText(u'插件')
        ...
        self.item_injector.setText(u'中间人代理')
        ...
        self.item_pumpkinProxy.setText(u'南瓜代理')
        ...
        self.item_packetsniffer.setText(u'TCP-攻击')
        ...
        self.item_imageCapture.setText(u'图片抓取')
    ...
    def initial_GUI_loader(self):
        ...
        Menu_file = self.myQMenuBar.addMenu(u'&文件')
        exportAction = QtGui.QAction(u'导入日职...', self)
        deleteAction = QtGui.QAction(u'清除日志', self)
        ...
        action_settings = QtGui.QAction(u'设置...',self)
        Menu_file.addAction(action_settings)

        Menu_View = self.myQMenuBar.addMenu(u'&视图')
        self.statusap_action = QtGui.QAction(u'状态', self.myQMenuBar, checkable=True)
        ...
        #tools Menu
        Menu_tools = self.myQMenuBar.addMenu(u'&工具')
        ...
        # server Menu
        Menu_Server = self.myQMenuBar.addMenu(u'&服务')
        btn_phishing = QtGui.QAction(u'钓鱼管理',self)
        btn_winup = QtGui.QAction(u'Windows更新',self)
        ...
        #menu module
        Menu_module = self.myQMenuBar.addMenu(u'&模板')
        ...
        #menu extra
        Menu_extra= self.myQMenuBar.addMenu(u'&帮助')
    ...
    def default_TAB_Content(self):
        ...
        self.StatusBar.addWidget(QtGui.QLabel(u'连接:'))
        ...
        self.StatusBar.addWidget(QtGui.QLabel(u"AP-状态:"))
        ...
        self.StatusBar.addWidget(QtGui.QLabel(u"客户端:"))
        ...
        self.btrn_refresh = QtGui.QPushButton(u'更新')
        ...
        self.btrn_find_Inet = QtGui.QPushButton(u'检查网络连接')
        ...
        self.GroupAdapter.setTitle(u'网络适配器')
        ...
        self.btn_start_attack = QtGui.QPushButton(u'开始', self)
        self.btn_start_attack.setIcon(QtGui.QIcon('icons/start.png'))
        self.btn_cancelar = QtGui.QPushButton(u'停止', self)
